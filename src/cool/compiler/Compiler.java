...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var classInheritancePassVisitor = new ClassInheritancePassVisitor();
        
        var featuresDefinitionPassVisitor = new FeaturesDefinitionPassVisitor();
        
        var featuresResolutionPassVisitor = new FeaturesResolutionPassVisitor();
        
        ast.accept(classDefinitionPassVisitor);
        ast.accept(classInheritancePassVisitor);
        ast.accept(featuresDefinitionPassVisitor);
        ast.accept(featuresResolutionPassVisitor);
